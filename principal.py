...
funciones.existe_archivo(ruta_libros)
funciones.existe_archivo(ruta_socios)
funciones.existe_archivo(ruta_prestamos)
funciones.existe_archivo(ruta_devoluciones)
    ...
    match opcion_usuario:
        case 1:
            ...
            #mostrar menu del registro de libros.
                funciones.menu('registro de libros')
                ...
                match opcion:
                    case 1:
                        #registrar un libro.
                        funciones.registrar_libro(ruta_libros)
        
                    case 2:
                        #editar un libro.
                        if funciones.verificar_json_vacio(ruta_libros):
                            print("No hay ningún libro registrado")
                        else:
                            funciones.mostrar_libros(ruta_libros)
                            ...
                            funciones.editar_libro(ruta_libros, id_libro, titulo_editado, autor_editado,editorial_editado, anio_editado, genero_editado, cantidad_editada)
                    ...
                    case 3:
                        ...
                        if funciones.verificar_json_vacio(ruta_libros):
                            ...
                            funciones.eliminar_libro(ruta_libros, id_libro)
                            funciones.mensaje()
                    ...
                    case 4:
                        ...
                        funciones.busqueda_libros(ruta_libros, titulo, genero, autor, editorial)
                    ...
                    case 5:
                        ...
                        funciones.recomendar_libros(ruta_libros, genero)
                    case 6:
            ...
            while True:
                ...
                match opcion:
                    case 1:
                        ...
                        funciones.agregar_socio(ruta_socios,nombre,apellido,fecha_nacimiento,direccion,correo,telefono)
                        
                    case 2:
                        #editar un socio
                        if funciones.verificar_json_vacio(ruta_socios):
                            print("No hay ningún socio registrado")
                        else:
                            funciones.mostrar_socios(ruta_socios)
                            ...
                            funciones.editar_socio(ruta_socios, id_socio, nombre2, apellido2,fecha_nacimiento2, direccion2, correo2, telefono2)
                    ...
                    case 3:
                        ...
                        if funciones.verificar_json_vacio(ruta_libros):
                            ...
                            funciones.eliminar_socio(ruta_socios, id_socio)
                            funciones.mensaje()
                    case 4:
                        print("¡Volviste al menú principal!")
                        break
        case 3:
            ...
            while True:
                funciones.menu('Prestamos y Devoluciones')
            ...
            #mostrar menu de Préstamos y devoluciones.
                ...
                match opcion:
                    case 1:
                        ...
                        funciones.registrar_prestamo(ruta_prestamos)
                    
                    case 2:
                        #mostrar fecha de un prestamo x
                        if funciones.verificar_json_vacio(ruta_prestamos):
                            print("No hay ningún préstamo registrado")
                        else:
                            funciones.mostrar_prestamos(ruta_prestamos)
                            id_prestamo=int(input("Por favor ingrese el ID del préstamo:  "))
                            funciones.mostrar_fecha_prestamo(ruta_prestamos, id_prestamo)
                    ...
                    case 3:
                        ...
                        if funciones.verificar_json_vacio(ruta_prestamos):
                            ...
                            funciones.registrar_devolucion(ruta_prestamos, ruta_devoluciones, id_prestamo, fecha_devolucion) 
                    ...
                    case 4:
                        ...
                        if funciones.verificar_json_vacio(ruta_prestamos):
                            ...
                            funciones.mostrar_prestamos(ruta_prestamos)
                            id_prestamo=int(input("Por favor ingrese el ID del préstamo:  "))
                            funciones.mostrar_fecha_devolucion(ruta_prestamos, id_prestamo)
                            
                    case 5:
                            #mostrar fecha de una devolucion realizada
                        if funciones.verificar_json_vacio(ruta_devoluciones):
                            print("No hay ninguna devolución registrada")
                        else:
                            funciones.mostrar_prestamos(ruta_devoluciones)
                            id_prestamo=int(input("Por favor ingrese el ID del préstamo:  "))
                            funciones.mostrar_fecha_devolucion(ruta_devoluciones, id_prestamo)
            
                    case 6:
                        #mostrar el estado de un préstamo
                        id_prestamo=int(input("Por favor ingrese el ID del préstamo:  "))
                        funciones.mostrar_estado(ruta_prestamos, ruta_devoluciones, id_prestamo)
                        
                    case 7:
                        #Generar reportes de prestamos y devoluciones por ID de socio 
                        funciones.mostrar_socios(ruta_socios)
                        ingreso_id=str(input("Por favor ingrese su ID de socio:  "))
                        funciones.id_socio_prestamo(ruta_prestamos, ruta_devoluciones, ingreso_id)
                        
                    case 8:
                        #Generar reportes de prestamos y devoluciones por ID del libro
                        funciones.mostrar_libros(ruta_libros)
                        ingreso_id=int(input("Por favor ingrese el ID del libro:  "))
                        funciones.id_libro_prestamo(ruta_prestamos, ruta_devoluciones, ingreso_id)
                    ...
                    case 9:
                        ...
                        funciones.registro_fecha(ruta_prestamos, ruta_devoluciones, inicio_fecha, fin_fecha)
